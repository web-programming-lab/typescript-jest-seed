import { MathBot, ArgumentError } from '../src/app'

describe('Math Bot', () => {

  it('add 1', () => {
    const question = 'What is 1 plus 1?'
    expect(new MathBot(question).answer()).toEqual(2)
  })

  xit('add 2', () => {
    const question = 'What is 53 plus 2?'
    expect(new MathBot(question).answer()).toEqual(55)
  })

  xit('add negative numbers', () => {
    const question = 'What is -1 plus -10?'
    expect(new MathBot(question).answer()).toEqual(-11)
  })

  xit('add more digits', () => {
    const question = 'What is 123 plus 45678?'
    expect(new MathBot(question).answer()).toEqual(45801)
  })

  xit('subtract', () => {
    const question = 'What is 4 minus -12?'
    expect(new MathBot(question).answer()).toEqual(16)
  })

  xit('multiply', () => {
    const question = 'What is -3 multiplied by 25?'
    expect(new MathBot(question).answer()).toEqual(-75)
  })
  ...
  xit('add twice', () => {
    ...
    expect(new MathBot(question).answer()).toEqual(3)
  })

  xit('add then subtract', () => {
    const question = 'What is 1 plus 5 minus -2?'
    expect(new MathBot(question).answer()).toEqual(8)
  })
  ...
  xit('subtract then add', () => {
    ...
    expect(new MathBot(question).answer()).toEqual(14)
  })

  xit('multiply twice', () => {
    const question = 'What is 2 multiplied by -2 multiplied by 3?'
    expect(new MathBot(question).answer()).toEqual(-12)
  })
  ...
  xit('too advanced', () => {
    ...
    const problem  = new MathBot(question)
